...
public sealed partial class NotificationView : UserControl
{
    ...
    private string? GetDisplayTitle(NotificationKind kind, string? title, int count)
    {
        return kind switch
        {
            ...
            NotificationKind.DiscNotFound => Strings.Resources.NoDiscFoundNotificationTitle,
            NotificationKind.AudioCdNotSupported => Strings.Resources.AudioCdNotSupportedNotificationTitle,
    ...
    private string? GetDisplayMessage(NotificationKind kind, string? message)
    {
        return kind switch
        {
            ...
            NotificationKind.DiscNotFound => Strings.Resources.NoDiscFoundNotificationMessage,
            NotificationKind.AudioCdNotSupported => Strings.Resources.AudioCdNotSupportedNotificationMessage,
